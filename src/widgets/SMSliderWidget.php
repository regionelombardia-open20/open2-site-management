...
class SMSliderWidget extends Widget
{
    ...
    {
        return $this->render($this->viewPath, ['slider' => $slider, 'optionsVideo' => $this->optionsVideo, 'optionsImg' => $this->optionsImg]);
    }
    ...
    public function registerJsVideo(){
        ...
        $('#carouselHeader').on('slid.bs.carousel', function(event){
        ...
        function onPlayerStateChange(event){
            if(event.data == YT.PlayerState.PLAYING){
                 $('#carouselHeader').carousel('pause');
            }
            if(event.data == YT.PlayerState.PAUSED || event.data == YT.PlayerState.ENDED){
                $('#carouselHeader').carousel('cycle');
            }
        }
